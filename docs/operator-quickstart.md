# Operator Quickstart — Activities of holding companies

Shortest path from clone to a verified local dry-run for **ISIC 6420** (`cloud-itonami-isic-6420`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6420.git
cd cloud-itonami-isic-6420
```
...
- Blueprint governor key: `holding-structure-governor`
- Likely source path: `holdco.governor.cljc`
