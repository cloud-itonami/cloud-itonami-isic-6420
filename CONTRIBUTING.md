...
`cloud-itonami-isic-6420` accepts contributions to the OSS blueprint, capability
...
- Keep disbursing a dividend/distribution or recording an ownership-structure change behind the Holding Structure Governor.
